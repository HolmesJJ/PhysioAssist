...
public class PostFormAuth extends AsyncTask<String, Void, String> {

    private final static String TAG = "PostForm";
    private OnTaskCompleted listener;
    private int requestId;

    public PostFormAuth(OnTaskCompleted listener, int requestId) {
        this.listener=listener;
        this.requestId = requestId;
    }

    public static String POST(String urlString, String data, String accessToken) {
        String result = "";
        try {
