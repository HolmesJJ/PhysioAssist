...
public class TutorialProgress extends Fragment {
    ...
    private TextView welcomePatient, textProgress;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.fragment_tutorial_progress, container, false);
        initView(rootView);
    ...
    private void initView(View rootView) {
        ...
        textProgress = rootView.findViewById(R.id.patient_tutorial_text_progress);
    ...
    private void initLanguage() {
        ...
        textProgress.setText(resources.getString(R.string.patient_tutorial_text_progress));
