...
public class TutorialChallenges extends Fragment {
    ...
    private TextView welcomePatient, textChallenge;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.fragment_tutorial_challenges, container, false);
        initView(rootView);
    ...
    private void initView(View rootView) {
        ...
        textChallenge = rootView.findViewById(R.id.patient_tutorial_text_challenges);
    ...
    private void initLanguage() {
        ...
        textChallenge.setText(resources.getString(R.string.patient_tutorial_text_challenges));
